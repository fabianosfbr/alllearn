    ...
    <div class="row">
            ...
            <div class="course-content-body user-select-none">
                ...
                <div class="mt-35">
                    <ul class="nav nav-tabs bg-secondary rounded-sm p-15 d-flex align-items-center justify-content-between" id="tabs-tab" role="tablist">
                        <li class="nav-item">
                            <a class="position-relative font-14 text-white {{ (empty(request()->get('tab','')) or request()->get('tab','') == 'information') ? 'active' : '' }}" id="information-tab" data-toggle="tab" href="#information" role="tab" aria-controls="information" aria-selected="true">{{ trans('product.information') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="position-relative font-14 text-white {{ (request()->get('tab','') == 'content') ? 'active' : '' }}" id="content-tab" data-toggle="tab" href="#content" role="tab" aria-controls="content" aria-selected="false">{{ trans('product.content') }} ({{ $webinarContentCount }})</a>
                        </li>
                        <li class="nav-item">
                            <a class="position-relative font-14 text-white {{ (request()->get('tab','') == 'reviews') ? 'active' : '' }}" id="reviews-tab" data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">{{ trans('product.reviews') }} ({{ $course->reviews->count() > 0 ? $course->reviews->pluck('creator_id')->count() : 0 }})</a>
                        </li>
                    </ul>
        ...
        <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                    ...
                    <form action="/cart/store" method="post">
                        ...
                        <div id="priceBox" class="d-flex align-items-center justify-content-center mt-20 {{ !empty($activeSpecialOffer) ? ' flex-column ' : '' }}">
                            <div class="text-center">
                                ...
                                @endphp
                                <span id="realPrice" data-value="{{ $course->price }}" data-special-offer="{{ !empty($activeSpecialOffer) ? $activeSpecialOffer->percent : ''}}" class="d-block @if(!empty($activeSpecialOffer)) font-16 text-gray text-decoration-line-through @else font-30 text-primary @endif">
                                    {{ $realPrice['price'] }}
                                </span>
            ...
            <div class="rounded-lg shadow-sm mt-35 px-25 py-20">
                <h3 class="sidebar-title font-16 text-secondary font-weight-bold">{{ trans('webinars.specifications') }}</h3>
                ...
                <div class="mt-30">
                    ...
                    <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                        ...
                        <span class="font-14">{{ dateTimeFormat($course->start_date, 'j M Y') }}</span>
                    </div>
                    ...
                    <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                        ...
                        <span class="font-14">
                            {{ $course->capacity == 0 ? "Ilimitado" : $course->capacity. " Estudantes"  }}
                        </span>
                    </div>
                    @endif
                    ...
                    <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                        ...
                        <span class="font-14">{{ !empty($course->duration) ? $course->duration : 0 }} </span>
                    </div>
...
<script>
    ...
    var canNotDownloadCertificateToastTitleLang = '{{ trans('
    public.can_not_download_certificate_toast_lang ') }}';
    var canNotDownloadCertificateToastMsgLang = '{{ trans('
