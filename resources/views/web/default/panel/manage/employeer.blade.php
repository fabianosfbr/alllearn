...
@section('content')
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">Colaboradores</span>
                    </div>
                </div>
    ...
    <section class="mt-35">
        <h2 class="section-title">Filtro de colaboradores</h2>
    ...
    <section class="mt-35">
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-gray">{{ trans('webinars.classes') }}</th>
        ...
        @else
            @include(getTemplate() . '.includes.no-result',[
                ...
                'title' => 'Nenhum colaborador foi adicionado ainda!',
                'hint' =>  'Você pode adicionar colaboradores à sua empresa',
                'btn' => ['url' => '/panel/manage/employeer/new','text' => 'Novo colaborador']
            ])
        @endif
    </section>
