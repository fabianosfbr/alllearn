<section class="mt-30">
    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                <label class="input-label {{ $user->isOrganization() ? 'd-none' : '' }} ">{{ trans('update.instructor_identity_scan') }}</label>
                <label class="input-label {{ !$user->isOrganization() ? 'd-none' : '' }} ">{{ trans('update.organization_identity_scan') }}</label>
