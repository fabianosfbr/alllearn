                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                <tr>
                                    <td class="headerContent" width="100%">
                                        <a href=""><img src="{{ url($generalSettings['logo']) }}" style="max-width:158px;margin-bottom: 8px;margin-top: 24px" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowtext/></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END PREHEADER -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                ...
                                {{--   <tr>
                                       <td valign="top" class="footerContent" mc:edit="footer_content00">
                                           <a href="*|TWITTER:PROFILEURL|*">Siga-nos no Twitter</a>&nbsp;&nbsp;&nbsp;<a href="*|FACEBOOK:PROFILEURL|*">Siga-nos Facebook</a>&nbsp;&nbsp;&nbsp;<a href="*|FORWARD|*">Compartilhe com um amigo</a>&nbsp;
                                       </td>
                                   </tr>--}}
                            </table>
                            <!-- // END FOOTER -->
