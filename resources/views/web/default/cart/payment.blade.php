    ...
    <section x-data="payment()" class="container mt-45" x-init="mpOptions">
        ...
        <div class="row">
            ...
            <div class="col-4 col-lg-4 mb-40 charge-account-radio">
                <input type="radio" name="payment_option" id="gateway" value="gateway"
          ...
          {{-- Botão para pagar com boleto, pix ou cartão --}}
          <div class="col-4 col-lg-4 mb-40 charge-account-radio">
            <input type="radio" name="payment_option" id="credicard" value="credicard"
                @click="showForm=2, showPaymentMethod=true">
            <label for="credicard"
                class="rounded-sm p-20 p-lg-45 d-flex flex-column align-items-center justify-content-center">
                <img src="/assets/default/img/activity/pay.svg" width="120" height="60" alt="">
            ...
            <div class="col-4 col-lg-4 mb-40 charge-account-radio">
                <input type="radio" name="payment_option" id="alllearn" value="credit"
                    @click="showForm=3, showPaymentMethod=false, creditCardForm=false, invoiceForm=false">
                <label for="alllearn"
                    class="rounded-sm p-20 p-lg-45 d-flex flex-column align-items-center justify-content-center">
                    <img src="/assets/default/img/activity/pay.svg" width="120" height="60" alt="">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <input type="email"
                                class="form-control @error('cardholderEmail') value="{{ !empty($user) ? $user->email : old('cardholderEmail') }}"  is-invalid @enderror"
                                name="cardholderEmail" id="form-checkout__cardholderEmail" />
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            ...
                            <input id="ddd" class="form-control @error('code_zone')  is-invalid @enderror""
                                ...
                                value="{{ !empty($user) ? $user->code_zone : old('code_zone') }}">
                            @error('code_zone')
                                <div class="invalid-feedback d-flex">
                                    {{ $message }}
                                </div>
                    ...
                    const cardForm = mp.cardForm({
                        ...
                        callbacks: {
                            ...
                            onPaymentMethodsReceived: (error, paymentMethods) => {
                                ...
                                document.querySelector('.brand').innerHTML = "<img src='" + paymentMethods[0]
                                    .thumbnail + "' alt='bandeira do cartão'>";
                            },
