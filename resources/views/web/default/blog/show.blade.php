                            ...
                            <span class="mt-10 mt-md-20 font-16 font-weight-500 text-white">{{ trans('public.created_by') }}
                                ...
                                @elseif(!empty($post->author->full_name))
                                    <span class="text-white text-decoration-underline">
                                        <a href="https://peopleacademy.com.br/" target="_blank" class="text-white text-decoration-underline">People Academy</a>
                                    </span>
                                @endif
                        </span>
                        @endif
            ...
            <div class="col-12 col-lg-4">
                @if(!empty($post->author->full_name))
                    <div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
                        ...
                        <h3 class="mt-10 font-18 font-weight-bold text-secondary">{{ $post->author->full_name }}</h3>
