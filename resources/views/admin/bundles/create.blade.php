            ...
            <div class="col-12 ">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post"
                            action="/admin/bundles/{{ !empty($bundle) ? $bundle->id.'/update' : 'store' }}"
                                    ...
                                    <div class="col-12 col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="locale"
                                                ...
                                                <option value="{{ $lang }}" @if(mb_strtolower(request()->get('locale',
                                                    app()->getLocale())) == mb_strtolower($lang)) selected @endif>{{
                                                    $language }}</option>
                                                @endforeach
                                            </select>
                                            @error('locale')
                                        ...
                                        <div class="form-group mt-15">
                                            ...
                                            <input type="text" name="slug"
                                                ...
                                                placeholder="" />
                                            <div class="text-muted text-small mt-1">{{ trans('update.bundle_url_hint')
                                                }}</div>
                                            @error('slug')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                        ...
                                        <div class="form-group mt-15 ">
                                            <label class="input-label d-block">{{ trans('admin/main.organization')
                                                }}</label>
                                        ...
                                        <div class="form-group mt-15 ">
                                            <label class="input-label d-block">{{
                                                trans('admin/main.select_a_instructor') }}</label>
                                        ...
                                        <div class="form-group mt-25">
                                            ...
                                            <div class="">
                                                ...
                                                <select name="video_demo_source"
                                                    ...
                                                    <option value="{{ $source }}" @if(!empty($bundle) and $bundle->
                                                        video_demo_source == $source) selected @endif>{{
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group mt-3 d-flex align-items-center justify-content-between">
                                            <label class="" for="subscribeSwitch">{{ trans('public.subscribe')
                                                }}</label>
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="subscribe" class="custom-control-input"
                                                    id="subscribeSwitch" {{ !empty($bundle) && $bundle->subscribe ?
                                                'checked' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="start_date"
                                                            ...
                                                            value="{{ !empty($bundle) ? $bundle->start_date : old('start_date') }}"
                                        ...
                                        <div class="form-group mt-15">
                                            ...
                                            <select id="categories"
                                                ...
                                                <optgroup label="{{  $category->title }}">
                                                    ...
                                                    <option value="{{ $subCategory->id }}" {{ (!empty($bundle) and
                                                        $bundle->category_id == $subCategory->id) ? 'selected' : ''
                                                        }}>{{ $subCategory->title }}</option>
                                                    @endforeach
                                                </optgroup>
                                                @else
                                                <option value="{{ $category->id }}" {{ (!empty($bundle) and $bundle->
                                    ...
                                    <div id="categoriesFiltersCard" class="row mt-3">
                                        ...
                                        <div class="col-12 col-md-3">
                                            <div class="webinar-category-filters">
                                                <strong class="category-filter-title d-block">{{ $filter->title
                                                    }}</strong>
                                                <div class="py-10"></div>
                                                ...
                                                <div
                                                    ...
                                                    <label class="text-gray font-14"
                                                        for="filterOptions{{ $option->id }}">{{ $option->title
                                                        }}</label>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" name="filters[]"
                                                            value="{{ $option->id }}" {{ ((!empty($bundleFilterOptions)
                                                            && in_array($option->id,$bundleFilterOptions)) ? 'checked' :
                                                        '') }} class="custom-control-input" id="filterOptions{{
                                                        $option->id }}">
                            ...
                            <section class="mt-30">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button id="webinarAddTicket" type="button" class="btn btn-primary btn-sm mt-3">{{
                                        trans('admin/main.add_price_plan') }}</button>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped text-center font-14">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ dateTimeFormat($ticket->start_date,'j F Y') }} - {{ (new
                                                        DateTime())->setTimestamp($ticket->end_date)->format('j F Y') }}
                                                    </td>
                                                    <td>
                                                        ...
                                                        '/admin/tickets/'. $ticket->id .'/delete', 'btnClass' => '
                                                        mt-1'])
                                                    </td>
                                                </tr>
                                                @endforeach
                            ...
                            <section class="mt-30">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button id="bundleAddNewCourses" type="button"
                                        class="btn btn-primary btn-sm mt-3">{{ trans('update.add_new_course')
                                        }}</button>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped text-center font-14">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">{{ $bundleWebinar->webinar->teacher->full_name
                                                        }}</td>
                                                    <td>{{
                                                        addCurrencyToPrice(handlePriceFormat($bundleWebinar->webinar->price))
                                                        }}</td>
                                                    <td>{{ dateTimeFormat($bundleWebinar->webinar->created_at,'j F Y |
                                                        H:i') }}</td>

                                                    <td>
                                                        <button type="button" data-item-id="{{ $bundleWebinar->id }}"
                                                        ...
                                                        @include('admin.includes.delete_button',['url' =>
                                                        '/admin/bundle-webinars/'. $bundleWebinar->id .'/delete',
                                                        'btnClass' => ' mt-1'])
                                                    </td>
                                                </tr>
                                                @endif
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped text-center font-14">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                            class="js-get-faq-description btn btn-sm btn-gray200">{{
                                                            trans('public.view') }}</button>
                                                        <input type="hidden" value="{{ $faq->answer }}" />
                                                    </td>

                                                    <td class="text-right">
                                                        <button type="button" data-faq-id="{{ $faq->id }}"
                                                            data-webinar-id="{{ !empty($bundle) ? $bundle->id : '' }}"
                                                        ...
                                                        @include('admin.includes.delete_button',['url' =>
                                                        '/admin/faqs/'. $faq->id .'/delete', 'btnClass' => ' mt-1'])
                                                    </td>
                                                </tr>
                                                @endforeach
                                    ...
                                    <div class="col-12">
                                        <div class="form-group mt-15">
                                            <textarea name="message_for_reviewer" rows="10"
                                                class="form-control">{{ (!empty($bundle) and $bundle->message_for_reviewer) ? $bundle->message_for_reviewer : old('message_for_reviewer') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <button type="button" id="saveAndPublish" class="btn btn-success">{{ !empty($bundle)
