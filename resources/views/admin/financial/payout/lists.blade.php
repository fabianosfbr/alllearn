                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="sort" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="amount_asc" @if(request()->get('sort') == 'amount_asc') selected @endif>Valor ascentende</option>
                                        <option value="amount_desc" @if(request()->get('sort') == 'amount_desc') selected @endif>Valor descentente</option>
                                        <option value="created_at_asc" @if(request()->get('sort') == 'created_at_asc') selected @endif>Data ascendente</option>
                                        <option value="created_at_desc" @if(request()->get('sort') == 'created_at_desc') selected @endif>Data descendente</option>
                                    </select>
                                </div>
                            </div>
