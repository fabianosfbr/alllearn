...
<div class="main-box">
    ...
    <div class="factor-logo-container">
        <img src="{{ getGeneralSettings('logo') }}" width="292" height="72" class=""/>
        <br>
        <h3 class="mt-3">{{ trans('financial.financial_documents') }}</h3>
    </div>
    <div class="print-2">
        <div>
    ...
    <table>
        ...
        <tr>
            <th class="th-1">
                {{ !empty($document->description) ? $document->description : 'Descrição' }}
            </th>
        </tr>
    ...
    <div class="print-4">
        ...
        <div class="print-5">
            ...
            <label>{{ !empty($document->creator_id) ? $document->creator->full_name : 'Automático' }}</label>
        </div>
    </div>
