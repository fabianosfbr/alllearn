                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="addiction"
                                                @if(request()->get('type',null) == 'addiction') selected="selected" @endif>Crédito</option>
                                        <option value="deduction"
                                                @if(request()->get('type',null) == 'deduction') selected="selected" @endif>Débito</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="type_account" class="form-control">
                                        ...
                                        <option value="asset"
                                                @if(request()->get('type_account',null) == 'asset') selected="selected" @endif>All Learn</option>
                                        <option value="income"
                                                @if(request()->get('type_account',null) == 'income') selected="selected" @endif>Mercado Pago</option>
                                        ...
                                        @foreach($documents as $document)
                                            <tr>
                                                ...
                                                <td width="20%">
                                                    ...
                                                    @if($document->type_account == 'asset')
                                                        All Learn
                                                    @else
                                                       Mercado Pago
                                                    @endif
