                                ...
                                <div class="row">
                                    <div class="col-12 col-md-5">
                                        ...
                                        <div class="form-group mt-15 ">
                                            ...
                                            <select name="teacher_id" data-search-option="just_teacher_role" class="form-control search-user-select2" data-placeholder="{{ trans('public.select_a_teacher') }}">
                                                @if(!empty($webinar))
                            ...
                            <section class="mt-3">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="row mt-15">
                                            @if(empty($webinar) or (!empty($webinar) and $webinar->isWebinar()))
                                            <div class="col-12 col-md-6 {{ (!empty(old('credit_card_installment')) and old('credit_card_installment') != \App\Models\Webinar::$webinar) ? 'd-none' : '' }}">
                                                <div class="form-group">
                                                    <label class="input-label">Qtde parcelas no cartão de crédito (1-12)</label>
                                                    <input type="number" min="1" max="12" name="credit_card_installment" value="{{ !empty($webinar) ? $webinar->credit_card_installment : old('credit_card_installment') }}" class="form-control @error('credit_card_installment')  is-invalid @enderror" />
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label class="input-label">Qtde parcelas no boleto (1-60)</label>
                                                    <input type="number" min="1" max="60" name="invoice_installment" value="{{ !empty($webinar) ? $webinar->invoice_installment : old('invoice_installment') }}" class="form-control @error('invoice_installment')  is-invalid @enderror" />
                                        ...
                                        <div class="row mt-15">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label class="input-label">Duração (Ex.: 6 horas)</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                        ...
                                        <div id="partnerInstructorInput" class="form-group mt-15 {{ !empty($webinar) && $webinar->partner_instructor ? '' : 'd-none' }}">
                                            ...
                                            <select name="partners[]" multiple data-search-option="just_teacher_role" class="form-control search-user-select2" data-placeholder="{{ trans('public.search_instructor') }}">
...
<script>
    ...
    var titleLang = '{{ trans('
    admin / main.title ') }}';
    var zoomJwtTokenInvalid = '{{ trans('
    admin / main.teacher_zoom_jwt_token_invalid ') }}';
    var editChapterLang = '{{ trans('
    public.edit_chapter ') }}';
    var requestFailedLang = '{{ trans('
    public.request_failed ') }}';
    var thisLiveHasEndedLang = '{{ trans('
    update.this_live_has_been_ended ') }}';
    var quizzesSectionLang = '{{ trans('
    quiz.quizzes_section ') }}';
