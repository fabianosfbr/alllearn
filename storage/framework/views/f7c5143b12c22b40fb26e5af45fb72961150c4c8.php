...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label class="input-label <?php echo e($user->isOrganization() ? 'd-none' : ''); ?> "><?php echo e(trans('update.instructor_identity_scan')); ?></label>
                <label class="input-label <?php echo e(!$user->isOrganization() ? 'd-none' : ''); ?> "><?php echo e(trans('update.organization_identity_scan')); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                <label class="input-label <?php echo e($user->isOrganization() ? 'd-none' : ''); ?> "><?php echo e(trans('update.instructor_certificate_and_documents')); ?></label>
                <label class="input-label <?php echo e(!$user->isOrganization() ? 'd-none' : ''); ?> "><?php echo e(trans('update.organization_certificate_and_documents')); ?></label>
                <div class="input-group">
                    <div class="input-group-prepend">
...
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/panel/setting/setting_includes/identity_and_financial.blade.php ENDPATH**/ ?>