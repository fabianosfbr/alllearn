    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">All Learn</h1>
                <h5 class="font-weight-normal text-muted-transparent">Lifelong Learning - Educação continuada</h5>
              </div>
              Todos os direitos reservados <a class="text-light bb" target="_blank" href="https://leandromorilhas.com.br">Leandro Morilhas Educacional</a> 
            </div>
          </div>
            </div>
...
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>