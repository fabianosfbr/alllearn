                ...
                <div class="card-body">
                    <div class="mt-3">
                        <form action="/admin/financial/documents" method="get" class="row mb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        <option value="addiction"
                                                <?php if(request()->get('type',null) == 'addiction'): ?> selected="selected" <?php endif; ?>>Crédito</option>
                                        <option value="deduction"
                                                <?php if(request()->get('type',null) == 'deduction'): ?> selected="selected" <?php endif; ?>>Débito</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label d-block">Conta</label>
                                    <select name="type_account" class="form-control">
                                        ...
                                        <option value="asset"
                                                <?php if(request()->get('type_account',null) == 'asset'): ?> selected="selected" <?php endif; ?>>All Learn</option>
                                        <option value="income"
                                                <?php if(request()->get('type_account',null) == 'income'): ?> selected="selected" <?php endif; ?>>Mercado Pago</option>
                                        ...
                                        <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-left">
                                                    <div class="text-left">
                                                        <?php if(!empty($document->webinar_id)): ?>
                                                            <span class="d-block font-weight-bold">Item</span>
                                                ...
                                                <td width="20%">
                                                    ...
                                                    <?php if($document->type_account == 'asset'): ?>
                                                        All Learn
                                                    <?php else: ?>
                                                       Mercado Pago
                                                    <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/admin/financial/documents/lists.blade.php ENDPATH**/ ?>