    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Novo Lançamento</div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="addiction">Crédito</option>
                                        <option value="deduction">Débito</option>
                                    </select>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/admin/financial/documents/new.blade.php ENDPATH**/ ?>