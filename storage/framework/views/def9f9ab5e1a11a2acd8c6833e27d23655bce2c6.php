                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                <tr>
                                    <td class="headerContent" width="100%">
                                        <a href=""><img src="<?php echo e(url($generalSettings['logo'])); ?>" style="max-width:158px;margin-bottom: 8px;margin-top: 24px" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowtext/></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END PREHEADER -->
...
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/layouts/email.blade.php ENDPATH**/ ?>