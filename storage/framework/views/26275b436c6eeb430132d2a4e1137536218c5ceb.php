...
<?php $__env->stopPush(); ?>
    <div>
        <br>
        <a href="https://atendimento.alllearn.com.br/article/9" target="_blank">Está com dúvida? <span style="font-weight: bold">Clique aqui</span> para saber como criar um curso.</a>
        <br>
    </div>
<div class="row">
...
unset($__errorArgs, $__bag); ?>" placeholder="Digite aqui o título do seu curso"/>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label">
                <?php echo e(trans('public.seo_description')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label ">
                <?php echo e(trans('public.thumbnail_image')); ?><span style="color: red; font-size: 12px;"> *Obrigatório</span> 
            </label>
            <div>
                <p class="font-12 text-gray">- A imagem que aparecerá na vitrine dos cursos.</p><br>
            </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label">
                <?php echo e(trans('public.cover_image')); ?><span style="color: red; font-size: 12px;"> *Obrigatório</span> 
            </label>
            <div>
                <p class="font-12 text-gray">- A imagem que aparecerá de fundo de capa quando clicado no curso.</p><br>
            </div>
            <div class="input-group">
                <div class="input-group-prepend">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-25">
            <label class="input-label">
                <?php echo e(trans('public.demo_video')); ?> (<?php echo e(trans('public.optional')); ?>)
            </label>
            <div>
                <p class="font-12 text-gray">- Vídeo que irá aparecer quando clicado para comprar seu curso.</p><br>
            </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/panel/webinar/create_includes/step_1.blade.php ENDPATH**/ ?>