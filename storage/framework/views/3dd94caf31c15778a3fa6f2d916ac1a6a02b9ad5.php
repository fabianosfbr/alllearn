                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td width="200" class="btn-sm">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_course_question_forum_answers')): ?>
                                                    <a href="/admin/webinars/<?php echo e($forum->webinar_id); ?>/forums/<?php echo e($forum->id); ?>/answers" target="_blank" class="btn-transparent btn-sm text-primary mt-1 mr-1" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('public.answers')); ?>">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/admin/webinars/forum/question_lists.blade.php ENDPATH**/ ?>