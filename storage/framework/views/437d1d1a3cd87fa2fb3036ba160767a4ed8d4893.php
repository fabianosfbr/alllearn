            ...
            <div class="col-12 col-lg-4">
                <?php if(!empty($post->author->full_name)): ?>
                    <div class="rounded-lg shadow-sm mt-35 p-20 course-teacher-card d-flex align-items-center flex-column">
                        ...
                        <h3 class="mt-10 font-18 font-weight-bold text-secondary"><?php echo e($post->author->full_name); ?></h3>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/blog/show.blade.php ENDPATH**/ ?>