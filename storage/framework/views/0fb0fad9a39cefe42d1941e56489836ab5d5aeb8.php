            ...
            <div class="col-12 <?php if($webinar->isWebinar()): ?> col-md-6 <?php endif; ?>">
                <div class="form-group">
                    <label class="input-label" data-bs-toggle="tooltip" data-bs-placement="right" title="Duração do total do curso">
                        <?php echo e(trans('public.duration')); ?> <i class="fa fa-info-circle"></i> 
                    </label>
                    <div class="input-group">
                        <div class="input-group-prepend">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\alllearn\resources\views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>