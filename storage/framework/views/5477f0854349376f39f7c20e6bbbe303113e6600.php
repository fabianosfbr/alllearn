        ...
        <div class="row">
            ...
            <div class="course-content-sidebar col-12 col-lg-4 mt-25 mt-lg-0">
                ...
                <div class="rounded-lg shadow-sm mt-35 px-25 py-20">
                    <h3 class="sidebar-title font-16 text-secondary font-weight-bold"><?php echo e(trans('webinars.specifications')); ?></h3>
                    ...
                    <div class="mt-30">
                        ...
                        <div class="mt-20 d-flex align-items-center justify-content-between text-gray">
                            ...
                            <span class="font-14"><?php echo e(!empty($course->duration) ? $course->duration : 0); ?> </span>
                        </div>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\alllearn\resources\views/web/default/course/index.blade.php ENDPATH**/ ?>