        ...
        <div class="top-contact-box border-bottom d-flex flex-column flex-md-row align-items-center justify-content-center">
            ...
            <div class="d-flex align-items-center justify-content-center">
                ...
                <?php if(!empty($generalSettings['site_email'])): ?>
                    ...
                    <span class="d-flex align-items-center py-10 py-lg-0 text-dark-blue font-14">
                         <ion-icon name="mail-outline" class="mr-10"></ion-icon>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/includes/top_nav.blade.php ENDPATH**/ ?>