    ...
    <div class="custom-modal-body">
        ...
        <div class="js-content-form chapter-form mt-20" data-action="/panel/chapters/store">
            ...
            <?php if(getFeaturesSettings('sequence_content_status')): ?>
                ...
                <div class="mt-15">
                    <p class="font-12 text-gray">- Ao selecionar esta opção, o aluno precisa concluir o módulo para conseguir avançar para o próximo.</p>
                </div>
            <?php endif; ?>
...
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/panel/webinar/create_includes/chapter_modal.blade.php ENDPATH**/ ?>