    ...
    <div class="col-12 col-md-6 mt-15">
        ...
        <?php if($webinar->isWebinar()): ?>
            <div class="form-group mt-15">
                ...
                <div>
                    <p class="font-12 text-gray">- Quantidade máxima de alunos no curso.</p><br>
                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 <?php if($webinar->isWebinar()): ?> col-md-6 <?php endif; ?>">
                <div class="form-group">
                    <label class="input-label" data-bs-toggle="tooltip" data-bs-placement="right" title="Duração do total do curso em minutos">
                        <?php echo e(trans('public.duration')); ?> (<?php echo e(trans('public.minutes')); ?>) <i class="fa fa-info-circle"></i> 
                    </label>
                    <div class="input-group">
                        <div class="input-group-prepend">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            <label class="cursor-pointer input-label" for="partnerInstructorSwitch">
                <?php echo e(trans('public.partner_instructor')); ?> 
            </label>
            <div class="custom-control custom-switch">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mt-15">
            <label class="input-label d-block">
                <?php echo e(trans('public.tags')); ?> (opcional)
            </label>
            <div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home1/lean0314/alllearn.com.br/public/resources/views/web/default/panel/webinar/create_includes/step_2.blade.php ENDPATH**/ ?>