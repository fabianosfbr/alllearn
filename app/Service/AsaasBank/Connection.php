...
class Connection
{
    ...
    public function get(string $url)
    {
        ...
        $response = $this->httpClient->get($this->base_url . '.asaas.com/api/v3' . $url);
    ...
    public function get_old($url, $option = false, $custom = false)
    {
        $ch = curl_init();
    ...
    public function post(string $url, array $body, string $param = "")
    {
        $endpoint = !empty($param) ? "{$this->base_url}/{$param}" : $this->base_url;

        $response = $this->httpClient->post($this->base_url . '.asaas.com/api/v3' . $url, $body);
    ...
    public function post_old($url, $params)
    {
