...
const numParcelaCredCard = document.getElementById('parcelasCredCard')
  ...
  checkCredCard.addEventListener('click', () => { 
    ...
    if(checkCredCard.checked === false || numParcelaCredCard == "") {
      numParcelaCredCard.classList.remove('d-flex')
    }
      numParcelaCredCard.classList.add('d-none')
  });
  ...
  checkBoleto.addEventListener('click', () => {
    ...
    if(checkBoleto.checked === false || numParcelaBoleto == "") {
      numParcelaBoleto.classList.remove('d-flex')
    }
      numParcelaBoleto.classList.add('d-none')
  });
